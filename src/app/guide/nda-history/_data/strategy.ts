 ...
 *  per single paper on the GAT (range 9–19 across 19 papers in the bank;
...
export const FOUNDATION_STRAND: StrategyStrand = {
  id: "foundation",
  label: "Foundation Recall — Ancient India + Medieval India (53 q · 37%)",
  qCount: 101,
  pctOfBank: 38,
  pitch:
...
export const QUICKWIN_STRAND: StrategyStrand = {
  ...
  approach: [
    ...
    "Industrial Revolution (14 q · 14% HARD) tests term-coiner identification (Arnold Toynbee in lectures 1880–81 at Oxford — published 1884; the term was popularised by Friedrich Engels earlier in 1844 but coined more formally by Toynbee). Key inventions: spinning jenny (Hargreaves 1764), water frame (Arkwright 1769), steam engine (Watt 1769), spinning mule (Crompton 1779), power loom (Cartwright 1785), cotton gin (Whitney 1793), telegraph (Morse 1837), telephone (Bell 1876), electric bulb (Edison 1879). Causes: agricultural revolution + capital accumulation from colonial trade + Britain's coal + iron + textile demand.",
