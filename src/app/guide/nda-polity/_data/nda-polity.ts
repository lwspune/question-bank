 ...
 *
 *   - SMALLEST GAT section we've guided (99 q · 4 ch · ~5 q/paper, range
 ...
 *     small samples) → 37% (2026) → 44% (2017) — no monotonic
...
export const ROUTES: GuideRoute[] = [
  {
    ...
    label: "Overview",
    blurb:
      "How NDA Polity actually works — what the 99-question bank reveals.",
  },
  {
    slug: "strategy",
    label: "Strategy",
...
export const OVERVIEW: Overview = {
  ...
  difficulty: { easy: 34, moderate: 46, hard: 19 },
  asOf: "2026-09-14",
};
 ...
 *  against the 99-q PUBLIC bank as of OVERVIEW.asOf. Numbers in `focus` may
...
export const CHAPTER_TABLE: ChapterRow[] = [
  ...
  },
  {
    ...
    pctHard: 31,
    focus:
      "Democracy and Political Theory (7 · 40% HARD — universal adult franchise chronology USA→Japan→Sri Lanka→India, democracy features, Lincoln's definition, US Declaration of Independence rights), United Nations and Global Institutions (6 · 60% HARD — densest %HARD subtopic in bank; UNSC non-permanent member elections + composition, UN Peacekeeping Operations ↔ countries pairs UNMOGIP UNFICYP UNMIK UNTSO UNDOF, UN Declarations chronology, SDG goals), India's Foreign Policy — Panchsheel (3 · 0% HARD — easy marks pocket; 5 principles of Panchsheel 1954, mutual non-aggression, peaceful coexistence). Lightest chapter by size, HARDEST %HARD — Specialist Wildcard pocket.",
  },
];
