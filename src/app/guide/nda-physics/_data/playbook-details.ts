...
export const PLAYBOOK_DETAILS: Record<string, PlaybookDetail> = {
  ...
  "electricity-and-magnetism": {
    ...
    story: [
      "93 q in 10 years · 22% HARD. The bank's #1 HARD pool by absolute count. Six subtopics: Resistance and Circuits (26 q · 42% HARD), Current Electricity (18 q), Electrical Devices (15 q), Electrostatics (13 q), Magnetism (13 q · 23% HARD), EM Rules (8 q).",
      "Resistance and Circuits is the marquee subtopic. R_series = sum, R_parallel = reciprocal sum. For two equal R in parallel: R/2. For N equal R in parallel: R/N. The 'wire of resistance R cut into N equal pieces and reconnected' shape: each piece R/N, N in parallel ⟹ R/N². Heat dissipation P = V²/R for fixed V: parallel (smaller R) dissipates MORE. Ratio P_parallel/P_series with same V and two equal R: 4.",
