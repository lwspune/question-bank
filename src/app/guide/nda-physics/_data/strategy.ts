...
export const REASON_STRAND: StrategyStrand = {
  ...
  approach: [
    ...
    "Resistance and Circuits is the bank's #1 marks-per-hour HARD pool (26 q at 42% HARD). Train the 5-shape repertoire: pure series, pure parallel, mixed series+parallel, ladder/infinite networks, and the 'wire of resistance R cut into pieces' shape.",
  ...
  chapters: [
    {
      ...
      studyHours: 10,
      summary:
        "93 q · 22% HARD — the bank's biggest chapter for HARD. Resistance 26 q at 42% HARD is the priority. Drill all six subtopics; HARD-target Resistance and Magnetism for extra reps.",
    },
    {
