...
export type Principle = {
  /** Display name */
  name: string;
  /** Estimated q coverage across the bank. Includes cross-chapter reuse, so
   *  the sum across all principles exceeds 1,320. */
  qCount: number;
  /** Approximate % HARD among questions invoking this principle. */
  pctHard?: number;
  /** One-sentence summary shown on the card. */
  summary: string;
  /** Best single subtopic to deep-link the "Drill →" CTA. */
...
export const TOP_20: Principle[] = [
  {
    ...
    qCount: 60,
    pctHard: 23,
    summary: "Whenever you need a minimum of a sum or maximum of a product under a constraint, AM-GM is the lever. Disguised across 10 chapters.",
    drill: { chapter: "Sequence & Series", subtopic: "Geometric and Harmonic Progressions, AM-GM-HM Relations" },
    chapters: ["App of Deriv", "Seq & Series", "Trig Identities", "Logs", "Functions"],
  },
  {
    ...
    qCount: 45,
    pctHard: 39,
    summary: "If α, β are roots of ax² + bx + c = 0, then α + β = −b/a and αβ = c/a. Never solve; use structure.",
    drill: { chapter: "Quadratic Equations", subtopic: "Vieta's Relations and Root-Coefficient Identities" },
    chapters: ["Quad Eq", "Complex", "Trig Identities", "Trig Eq", "M&D", "Properties of Triangle"],
  },
  {
    slug: "ap-three-term",
    ...
    qCount: 40,
    pctHard: 23,
    summary: "If a, b, c are in AP, then 2b = a + c. Appears in 7 chapters under different disguises (logs in AP, C(n,r) in AP, sides of triangle in AP).",
    drill: { chapter: "Sequence & Series", subtopic: "Arithmetic Progression — Sum, nth Term, Ratios" },
    chapters: ["Seq & Series", "Logs", "M&D", "P&C", "Probability", "Triangle", "Lines"],
  },
  {
    slug: "gp-three-term",
    ...
    drill: { chapter: "Sequence & Series", subtopic: "Geometric and Harmonic Progressions, AM-GM-HM Relations" },
    chapters: ["Seq & Series", "Logs", "M&D", "Quad Eq"],
  },
  {
    slug: "compound-angle",
    ...
    chapters: ["Trig Identities", "Trig Eq", "Properties of Triangle"],
  },
  {
    slug: "double-angle",
    ...
    drill: { chapter: "Trigonometric Identities", subtopic: "Multiple and Half-Angle Formulas" },
    chapters: ["Trig Identities", "Trig Eq", "Properties of Triangle"],
  },
  {
    ...
    chapters: ["Properties of Triangle", "Trig Identities", "Vectors"],
  },
  {
    ...
    qCount: 50,
    pctHard: 35,
    summary: "a/sin A = 2R and c² = a² + b² − 2ab cos C. Drives every \"solve the triangle\" problem.",
    drill: { chapter: "Properties of Triangle", subtopic: "Sine and Cosine Rules — Solving Triangles" },
  ...
  },
  {
    ...
    drill: { chapter: "Complex Numbers", subtopic: "Cube Roots of Unity" },
    chapters: ["Complex", "Quad Eq", "M&D"],
  },
  {
    ...
    drill: { chapter: "Sets & Relations", subtopic: "Counting Sets, Subsets, and Inclusion-Exclusion" },
  ...
  },
  {
    ...
    qCount: 37,
    pctHard: 22,
    summary: "ΣC(n,r) = 2ⁿ, C(n,r) = C(n,n−r), Pascal's rule. Used in 6 chapters from Binomial Theorem to Statistics.",
    drill: { chapter: "Binomial Theorem", subtopic: "Coefficients and Specific Terms in Expansion" },
    chapters: ["Binomial Theorem", "Binomial Distribution", "P&C", "M&D", "Seq & Series"],
  },
  {
    ...
    qCount: 43,
    pctHard: 15,
    summary: "Piecewise splitting at zero. The principle behind the 2023 modulus spike — high in recent papers.",
    drill: { chapter: "Limits & Continuity", subtopic: "One-Sided Limits, Greatest Integer, and Absolute Value Limits" },
    chapters: ["App of Deriv", "Apps of Int", "Def Int", "Diff Eq", "Diff", "Functions", "Limits & Continuity", "Sets & Relations"],
  },
  {
    ...
    chapters: ["App of Deriv", "Trig Identities", "Stats"],
  },
  {
  ...
  },
  {
    ...
    drill: { chapter: "Differentiation", subtopic: "Differentiability of Absolute Value, Piecewise, and Greatest Integer Functions" },
    chapters: ["Differentiation", "Limits & Continuity"],
  },
  {
  ...
  },
  {
    ...
    qCount: 39,
    pctHard: 31,
    summary: "Largest single subtopic in the bank. Cofactor expansion + row/column operations are the workhorses.",
