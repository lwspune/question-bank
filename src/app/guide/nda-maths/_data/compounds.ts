...
export const COMPOUNDS: CompoundRecipe[] = [
  {
    ...
    drillFilter: {
      ...
      note: "This subtopic IS the compound — all 20 q live here.",
    },
    soloA: {
  ...
  },
  {
    ...
    bankPctHard: 24.4,
    description:
      "Cube roots of unity treated as polynomial roots. The classic shape: 'if α, β are roots of x² + x + 1 = 0, find α^n + β^n'. The roots are ω, ω² — and ω satisfies 1 + ω + ω² = 0 with ω³ = 1. Powers cycle every 3, so the answer is a small case match.",
    examples: [
    ...
    drillFilter: {
      ...
      note: "The Cube Roots of Unity subtopic (12 q) is where most ω + Vieta lives.",
    },
    soloA: {
      chapter: "Complex Numbers",
      subtopic: "Cube Roots of Unity",
