 ...
 *     Only 4 HARDs across 199 q · 10 yrs = 2.1% overall. 4 of 9 chapters
...
export const ROUTES: GuideRoute[] = [
  {
    ...
    label: "Overview",
    blurb:
      "How NDA Biology actually works — what the 199-question bank reveals.",
  },
  {
    slug: "strategy",
    label: "Strategy",
...
export const OVERVIEW: Overview = {
  ...
  difficulty: { easy: 134, moderate: 61, hard: 4 },
  asOf: "2026-09-14",
};
 ...
 *  against the 199-q PUBLIC bank as of OVERVIEW.asOf. Numbers in `focus` may
...
export const CHAPTER_TABLE: ChapterRow[] = [
  {
    ...
    pctHard: 2,
    focus:
      "Connective and Epithelial Tissues (9 · the building-block tissues), Nervous System and Sense Organs (9 · neurons, reflex arc, eye), Nutrition, Vitamins and Minerals (8 · vitamin↔deficiency table), Digestive System and Enzymes (8 · 14% HARD), Circulatory and Lymphatic System (6 · heart, vessels, clotting), Endocrine System and Hormones (5), Respiratory System (5), Excretory and Reproductive Anatomy (3), Immune System (2).",
  },
  {
    ...
    pctHard: 2,
    focus:
      "Cell Organelles and Functions (17 · ribosome/mitochondria/golgi/ER), Cell Structure Fundamentals (6), Prokaryotic vs Eukaryotic Cells (6), Osmosis and Tonicity (4 · 25% HARD — chapter's lone trap subtopic), Cell Wall and Cell Membrane (4), Cellular Respiration and ATP (5), Cell Division and DNA Replication (2), Microscopy (2).",
  },
  {
    ...
    pctHard: 3,
    focus:
      "Plant Tissues and Meristems (12 · xylem/phloem/meristem), Photosynthesis (10 · light/dark reactions, chloroplast), Seed, Fruit and Embryo Development (4), Transpiration, Tropisms and Plant Processes (3 · 33% HARD — chapter's lone HARD pool), Vegetative Propagation (1).",
  },
  {
  ...
  },
  {
    ...
    pctHard: 6,
    focus:
      "Angiosperm Reproduction — Pollination and Fertilization (9), Sexual Reproduction — Genetic Principles (3 · 33% HARD — chapter's lone HARD), Animal and Human Reproduction (3 · oestrus cycle), Meiosis and DNA in Flowering Plants (1).",
  },
  {
    ...
    pctHard: 0,
    focus:
      "Environment and Biodiversity (5), Ecosystems, Biomes and Ecological Interactions (6 · biome characteristics, food chains). Zero HARD across 10 years.",
  },
  {
    ...
    pctHard: 0,
    focus:
      "Animal Kingdom Classification (5 · phylum Porifera/sponges, arthropods), Plant Kingdom Classification (5 · bryophytes/pteridophytes), Kingdom Fungi (2). Zero HARD across 10 years.",
  },
  {
