...
import { PLAYBOOKS } from "@/app/guide/nda-physics/_data/playbooks";
...
/**
 * Cross-link card row at the bottom of a /guide/nda-physics/playbooks/[slug]
 * page. Editorial pick — 2–3 related playbooks per detail page. Parallel to
 * RelatedPlaybooks (nda-english) and RelatedPrinciples (nda-maths) — kept as
 * its own component because the link path is hard-coded per guide.
 */
export default function RelatedPhysicsPlaybooks({ slugs }: Props) {
  const items = slugs
