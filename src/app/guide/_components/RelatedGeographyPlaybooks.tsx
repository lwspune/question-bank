...
import { PLAYBOOKS } from "@/app/guide/nda-geography/_data/playbooks";
...
/**
 * Cross-link card row at the bottom of a /guide/nda-geography/playbooks/[slug]
 * page. Editorial pick — 2–3 related playbooks per detail page. Parallel to
 * RelatedBiologyPlaybooks, RelatedChemistryPlaybooks, RelatedPhysicsPlaybooks,
 * RelatedPlaybooks (english) and RelatedPrinciples (maths) — kept as its own
 * component because the link path is hard-coded per guide.
 */
export default function RelatedGeographyPlaybooks({ slugs }: Props) {
  const items = slugs
