...
import { PLAYBOOKS } from "@/app/guide/nda-history/_data/playbooks";
...
/**
 * Cross-link card row at the bottom of a /guide/nda-history/playbooks/[slug]
 * page. Editorial pick — 2–3 related playbooks per detail page. Parallel to
 * RelatedBiologyPlaybooks, RelatedChemistryPlaybooks, RelatedGeographyPlaybooks,
 ...
 * per guide.
 */
export default function RelatedHistoryPlaybooks({ slugs }: Props) {
  const items = slugs
