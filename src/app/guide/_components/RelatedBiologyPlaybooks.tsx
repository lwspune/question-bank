...
import { PLAYBOOKS } from "@/app/guide/nda-biology/_data/playbooks";
...
/**
 * Cross-link card row at the bottom of a /guide/nda-biology/playbooks/[slug]
 * page. Editorial pick — 2–3 related playbooks per detail page. Parallel to
 * RelatedChemistryPlaybooks, RelatedPhysicsPlaybooks, RelatedPlaybooks
 * (english) and RelatedPrinciples (maths) — kept as its own component
 * because the link path is hard-coded per guide.
 */
export default function RelatedBiologyPlaybooks({ slugs }: Props) {
  const items = slugs
