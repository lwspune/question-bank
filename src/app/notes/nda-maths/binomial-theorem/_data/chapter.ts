...
export const BINOMIAL_THEOREM_CHAPTER: ChapterNote = {
  ...
  intro:
    "Binomial Theorem is a formula-driven chapter: once you can write the general term, most questions are a single substitution. 56 PYQs span 2017–2026, formula-heavy but tricky — the marks come from picking the right value of r, not from heavy algebra. " +
