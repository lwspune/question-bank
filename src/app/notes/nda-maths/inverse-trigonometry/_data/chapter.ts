...
export const INVERSE_TRIGONOMETRY_CHAPTER: ChapterNote = {
  ...
  intro:
    "Inverse trigonometry asks the reverse question — given a ratio, which angle produced it? — with one twist: the answer must lie in a fixed principal-value range. 36 PYQs span 2017–2026, formula-heavy and unforgiving on the range. " +
