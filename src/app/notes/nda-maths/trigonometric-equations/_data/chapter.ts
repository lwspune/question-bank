...
export const TRIGONOMETRIC_EQUATIONS_CHAPTER: ChapterNote = {
  ...
  intro:
    "A trigonometric equation has infinitely many solutions — the trick is to write the whole family with one general-solution formula, then count how many land in the interval the question asks about. 34 PYQs span 2017–2026, a third of them HARD. " +
