...
export const PROPERTIES_OF_TRIANGLE_CHAPTER: ChapterNote = {
  ...
  intro:
    "Properties of Triangle is the toughest yield in NDA Maths — 52 PYQs, 42% of them HARD. Everything connects the sides a, b, c to the angles A, B, C, and the marks come from choosing the right relation: the sine rule, the cosine rule, or a triangle identity that uses A + B + C = π. " +
