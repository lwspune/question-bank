...
export const MATTER_STATES_CHAPTER: ChapterNote = {
  ...
  intro:
    ...
    "(2) Physical vs chemical changes — the one test (is a new substance formed?) and the everyday examples on each side; " +
    "(3) Compounds, mixtures and solutions — the pure-substance vs mixture tree, homogeneous vs heterogeneous, and mass-percentage of a solution; " +
    "(4) Colloids and suspensions — the particle-size ladder (solution → colloid → suspension), the Tyndall effect, and soap micelles; " +
    "(5) Separation techniques — distillation, fractional distillation, separating funnel, centrifugation, chromatography, sublimation, evaporation and crystallization, each matched to the mixture it separates. " +
    "13 concepts, every PYQ tagged. Most concepts are reference tables: memorise the table, win the marks.",
  subtopicOrder: [
    "matt-states",
    "matt-changes",
    "matt-mixtures",
