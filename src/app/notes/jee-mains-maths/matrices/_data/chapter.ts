...
export const JEE_MATRICES_CHAPTER: ChapterNote = {
  ...
  intro:
    "Matrices is a near-guaranteed scorer on JEE Mains — 115 past-year questions across " +
    "2021–2026, roughly one to two questions on every shift. But JEE tests matrices very " +
