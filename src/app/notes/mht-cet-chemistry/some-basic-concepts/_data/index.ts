...
import { GAS_LAWS_NOTE } from "./cetsbcc-gas-laws";
import { DALTON_KTG_NOTE } from "./cetsbcc-dalton-ktg";
...
export const SOME_BASIC_CONCEPTS_NOTES: Record<string, SubtopicNote> = {
  ...
  "cetsbcc-gas-laws": GAS_LAWS_NOTE,
  "cetsbcc-dalton-ktg": DALTON_KTG_NOTE,
};
