...
export const INDIAN_GEOGRAPHY_PHYSICAL_CHAPTER: ChapterNote = {
  ...
  intro:
    ...
    "(3) Indian rivers, lakes and water bodies — the Himalayan vs Peninsular river systems, tributaries, lakes, river features and waterways; " +
    "(4) Indian soils and climate-agriculture — the soil types and their crops, the monsoon and its quirks; " +
    "(5) Forests and natural vegetation of India — vegetation belts, forest cover, biosphere reserves and protected areas; " +
    "(6) Indian states and islands — borders, state facts, islands and coral reefs. " +
    "Most questions are EASY/MODERATE; the HARD ones are the match-the-list and arrange-in-order items. Drill the tables, win the marks.",
  subtopicOrder: [
    "igp-location-extent-frontiers",
    "igp-mountains-plateaus-plains",
    "igp-rivers-lakes-water-bodies",
    "igp-soils-climate-agriculture",
    "igp-forests-natural-vegetation",
    "igp-states-and-islands",
  ],
};
