    ...
    <Popover.Root>
      ...
      <Popover.Portal>
        ...
        >
          ...
          {/* Org members (ADMIN or TEACHER) get the collaborative paper builder.
              Lives here, not the dashboard, because teachers are redirected away
              from /dashboard but still need to reach Papers. */}
