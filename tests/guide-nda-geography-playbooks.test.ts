/**
 * Integration test for the /guide/nda-geography playbook tree.
 *
 * Mirrors the equivalent english + physics + chemistry + biology tests —
 ...
 *      NDA Geography taxonomy via resolveTaxonomy — catches the silent
...
import { PLAYBOOK_DETAILS } from "@/app/guide/nda-geography/_data/playbook-details";
...
describe("nda-geography playbooks — static structure", () => {
...
describe.skipIf(!HAS_ENV)(
  "nda-geography playbooks — live taxonomy resolution",
  () => {
    ...
    it("every playbook's chapter + subtopic names resolve under live NDA Geography taxonomy", async () => {
      const taxonomy = await resolveTaxonomy(client, "NDA", "Geography");
