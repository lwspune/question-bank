...
export const CHAPTERS: Record<string, Chapter> = {
  ...
  // ── The remaining eleven Class 10 Science chapters. Ch.1 proved the spine and
  //    Ch.11 the hazards; from here the shape is settled and each chapter's only
  //    open question is its OWN key denominator, which science-items.ts reports.
  //    Answer pages: jesc1an p0 carries Chapters 1-9, p1 carries 10-13.
  ...
  c10SciAcidsBases: {
    ...
    examId: EXAM_ID_CBSE_10,
    subjectName: "Science",
    sourceFile: "NCERT_10_Science__AcidsBasesAndSalts.pdf",
    pdf: cls10Sci("02. Acids, Bases, and Salts.pdf"),
    answersPdf: cls10Sci("jesc1an.pdf"),
    answerPages: [0],
    chapterNo: 2,
    note: "NCERT (CBSE Class 10) — Acids, Bases and Salts (Chapter 2, NCERT Science)",
    subtopics: [
      "Chemical Properties of Acids and Bases",
      "Reactions with Metals and Carbonates",
      "Neutralisation and Salt Formation",
      "pH Scale and its Importance",
      "Common Salt and Chemicals from It",
      "Water of Crystallisation",
    ],
  },

  c10SciMetalsNonmetals: {
    id: "c10SciMetalsNonmetals",
    chapterName: "Metals and Non-metals",
    examId: EXAM_ID_CBSE_10,
    subjectName: "Science",
    sourceFile: "NCERT_10_Science__MetalsAndNonMetals.pdf",
    pdf: cls10Sci("03. Metals and Non-metals.pdf"),
    answersPdf: cls10Sci("jesc1an.pdf"),
    answerPages: [0],
    chapterNo: 3,
    note: "NCERT (CBSE Class 10) — Metals and Non-metals (Chapter 3, NCERT Science)",
    subtopics: [
  ...
  c10SciCarbon: {
    ...
    examId: EXAM_ID_CBSE_10,
    subjectName: "Science",
    sourceFile: "NCERT_10_Science__CarbonAndItsCompounds.pdf",
    pdf: cls10Sci("04. Carbon and its Compounds.pdf"),
    answersPdf: cls10Sci("jesc1an.pdf"),
    answerPages: [0],
    chapterNo: 4,
    note: "NCERT (CBSE Class 10) — Carbon and its Compounds (Chapter 4, NCERT Science)",
    subtopics: [
  ...
  c10SciLifeProcesses: {
    id: "c10SciLifeProcesses",
    chapterName: "Life Processes",
    examId: EXAM_ID_CBSE_10,
    subjectName: "Science",
    sourceFile: "NCERT_10_Science__LifeProcesses.pdf",
    pdf: cls10Sci("05. Life Processes.pdf"),
    answersPdf: cls10Sci("jesc1an.pdf"),
    answerPages: [0],
    chapterNo: 5,
    note: "NCERT (CBSE Class 10) — Life Processes (Chapter 5, NCERT Science)",
    subtopics: [
  ...
  c10SciControlCoordination: {
    id: "c10SciControlCoordination",
    chapterName: "Control and Coordination",
    examId: EXAM_ID_CBSE_10,
    subjectName: "Science",
    sourceFile: "NCERT_10_Science__ControlAndCoordination.pdf",
    pdf: cls10Sci("06. Control and Coordination.pdf"),
    answersPdf: cls10Sci("jesc1an.pdf"),
    answerPages: [0],
    chapterNo: 6,
    note: "NCERT (CBSE Class 10) — Control and Coordination (Chapter 6, NCERT Science)",
    subtopics: [
      "Nervous System and Neurons",
      "Reflex Action",
      "Human Brain and Protection of Nervous Tissue",
  ...
  c10SciReproduction: {
    id: "c10SciReproduction",
    chapterName: "How do Organisms Reproduce?",
    examId: EXAM_ID_CBSE_10,
    subjectName: "Science",
    sourceFile: "NCERT_10_Science__HowDoOrganismsReproduce.pdf",
    pdf: cls10Sci("07. How do Organisms Reproduce.pdf"),
    answersPdf: cls10Sci("jesc1an.pdf"),
    answerPages: [0],
    chapterNo: 7,
    note: "NCERT (CBSE Class 10) — How do Organisms Reproduce? (Chapter 7, NCERT Science)",
    subtopics: [
  ...
  c10SciHeredity: {
    ...
    examId: EXAM_ID_CBSE_10,
    subjectName: "Science",
    sourceFile: "NCERT_10_Science__Heredity.pdf",
    pdf: cls10Sci("08. Heredity.pdf"),
    answersPdf: cls10Sci("jesc1an.pdf"),
    answerPages: [0],
    chapterNo: 8,
    note: "NCERT (CBSE Class 10) — Heredity (Chapter 8, NCERT Science)",
    subtopics: [
      "Accumulation of Variation",
      "Inherited Traits and Mendel's Experiments",
  ...
  c10SciLight: {
    ...
    examId: EXAM_ID_CBSE_10,
    subjectName: "Science",
    sourceFile: "NCERT_10_Science__LightReflectionAndRefraction.pdf",
    pdf: cls10Sci("09. Light.pdf"),
    answersPdf: cls10Sci("jesc1an.pdf"),
    answerPages: [0],
    chapterNo: 9,
    note: "NCERT (CBSE Class 10) — Light: Reflection and Refraction (Chapter 9, NCERT Science)",
    subtopics: [
      "Reflection of Light",
  ...
  c10SciHumanEye: {
    ...
    examId: EXAM_ID_CBSE_10,
    subjectName: "Science",
    sourceFile: "NCERT_10_Science__TheHumanEyeAndTheColourfulWorld.pdf",
    pdf: cls10Sci("10. Human Eye.pdf"),
    answersPdf: cls10Sci("jesc1an.pdf"),
    answerPages: [1], // p1 carries Chapters 10-13
    chapterNo: 10,
    note: "NCERT (CBSE Class 10) — The Human Eye and the Colourful World (Chapter 10, NCERT Science)",
    subtopics: [
  ...
  c10SciMagneticEffects: {
    id: "c10SciMagneticEffects",
    chapterName: "Magnetic Effects of Electric Current",
    examId: EXAM_ID_CBSE_10,
    subjectName: "Science",
    sourceFile: "NCERT_10_Science__MagneticEffectsOfElectricCurrent.pdf",
    pdf: cls10Sci("12. Magnetic Effects of Electric Current.pdf"),
    answersPdf: cls10Sci("jesc1an.pdf"),
    answerPages: [1],
    chapterNo: 12,
    note: "NCERT (CBSE Class 10) — Magnetic Effects of Electric Current (Chapter 12, NCERT Science)",
    subtopics: [
  ...
  // A CORRECTION KEPT ON PURPOSE. The heading extractor found 13.1, 13.1.1,
  // 13.2.1 and 13.2.2 but no "13.2", and the first draft of this comment
  // concluded the reprint had dropped the parent section. IT HAD NOT — §13.2
  // "How do our Activities Affect the Environment?" is printed on page 212,
  // wrapped across two lines, which is why a single-line heading scan missed it.
  // The render is the authority; an extractor's silence is not evidence.
  c10SciOurEnvironment: {
    id: "c10SciOurEnvironment",
    chapterName: "Our Environment",
    examId: EXAM_ID_CBSE_10,
    subjectName: "Science",
    sourceFile: "NCERT_10_Science__OurEnvironment.pdf",
    pdf: cls10Sci("13. Our Environment.pdf"),
    answersPdf: cls10Sci("jesc1an.pdf"),
    answerPages: [1],
    chapterNo: 13,
    note: "NCERT (CBSE Class 10) — Our Environment (Chapter 13, NCERT Science)",
    subtopics: [
