 ...
 *
 *   npx tsx scripts/ncert/attach-solution-image.ts <chapterId>          # dry-run: validate manifest + files
 *   npx tsx scripts/ncert/attach-solution-image.ts <chapterId> --apply  # upload + set solution_image_url
 *
