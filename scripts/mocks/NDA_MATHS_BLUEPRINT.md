...
|---|---|---|
| Conics | 1/1/0 | Parabola — Equation, Properties, Latus Rectum (1·M) · Ellipse — Foci, Eccentricity, Focal Distances (1·E) |
| Indefinite Integration | 0/1/1 | Integration by Substitution (1·H) · Standard Forms — Exponential, Logarithmic, Paired Trig (1·M) |
| Inverse Trigonometry | 0/1/1 | Identities, Properties, Sum-Difference Formulas (1·M) · Evaluation of Composite Inverse Trig Expressions (1·H) |
| Binomial Distribution | 1/1/0 | Computing Binomial Probabilities (1·E) · Mean, Variance, Parameter Estimation in B(n,p) (1·M) |
| Trigonometric Equations | 0/1/1 | General Solutions and Counting Solutions (1·H) · Solving Specific Forms — Double-Angle, Product, Logarithmic, Vieta (1·M) |
...
| Circles | 0/1/1 | Circle Equation — Centre, Radius, Diameter (1·M) · Inscribed Geometry, Tangents, Segments (1·H) |
