 ...
 *
 *   npx tsx scripts/mh-sb-9/snap-crop.ts <chapterId>          # derive + report (dry: writes nothing)
 *   npx tsx scripts/mh-sb-9/snap-crop.ts <chapterId> --write  # write derived bboxes into the *fig.json fragments
 *
