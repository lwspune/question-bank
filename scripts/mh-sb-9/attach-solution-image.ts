 ...
 *
 *   npx tsx scripts/mh-sb-9/attach-solution-image.ts <chapterId>          # dry-run: validate manifest + files
 *   npx tsx scripts/mh-sb-9/attach-solution-image.ts <chapterId> --apply  # upload + set solution_image_url
 *
