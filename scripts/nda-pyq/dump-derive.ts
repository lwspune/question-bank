 ...
 *
 *   npx tsx scripts/nda-pyq/dump-derive.ts <paperId>
 *   npx tsx scripts/nda-pyq/dump-derive.ts <paperId> --apply
 *
...
function main() {
  ...
  console.log(`  page images: scripts/nda-pyq/out/${paper.id}/pNN.png`);
