 ...
 *
 *   npx tsx scripts/mh-sb-9/backfill-sections.ts <chapterId>          # dry-run: print the reconstructed outline
 *   npx tsx scripts/mh-sb-9/backfill-sections.ts <chapterId> --apply  # write the columns
 *
