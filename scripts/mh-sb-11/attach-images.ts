 ...
 *
 *   npx tsx scripts/mh-sb-11/attach-images.ts <chapterId>          # dry-run: crop to out/ for eyeballing
 *   npx tsx scripts/mh-sb-11/attach-images.ts <chapterId> --apply  # upload + set image_url
 *
