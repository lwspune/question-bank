 ...
 *
 *   npx tsx scripts/mh-sb-11/errata.ts            # print the report to stdout
 *   npx tsx scripts/mh-sb-11/errata.ts --write    # also write generated-papers/StateBoard_Errata.md
 *
...
const THEORY_ERRATA: { chapter: string; where: string; type: string; issue: string }[] = [
  // None found yet in the Class-11 books. (This list started life as a copy of the
  // Class-9 pipeline's, which carried a Real Numbers entry — that belongs to
  // scripts/mh-sb-9 and was removed here so this report stays Class-11 only.)
];
