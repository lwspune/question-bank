 ...
 *
 *   npx tsx scripts/mh-sb-11/backfill-sections.ts <chapterId>          # dry-run: print the reconstructed outline
 *   npx tsx scripts/mh-sb-11/backfill-sections.ts <chapterId> --apply  # write the columns
 *
