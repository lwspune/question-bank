 ...
 *
 *   npx tsx scripts/stateboard/backfill-sections.ts <chapterId>          # dry-run: print the reconstructed outline
 *   npx tsx scripts/stateboard/backfill-sections.ts <chapterId> --apply  # write the columns
 *
