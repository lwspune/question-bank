...
export const SECTIONS: Record<string, SectionSpec[]> = {
  ...
  "tertiary-activities-12-geo": [
    { group: "Chapter activities", label: "Try this / Can you tell? / Use your brain power!", kind: "exercise", refPrefixes: ["Act "] },
    { group: "Exercise", label: "Exercise", kind: "exercise", refPrefixes: ["Ex "] },
  ],
  "secondary-activities-12-geo": [
    { group: "Chapter activities", label: "Try this / Make friends with maps! / Use your brain power!", kind: "exercise", refPrefixes: ["Act "] },
    { group: "Exercise", label: "Exercise", kind: "exercise", refPrefixes: ["Ex "] },
  ],
  "primary-activities-12-geo": [
    { group: "Chapter activities", label: "Make friends with maps! / Try this / Give it a try", kind: "exercise", refPrefixes: ["Act "] },
    { group: "Exercise", label: "Exercise", kind: "exercise", refPrefixes: ["Ex "] },
  ],
  "settlements-12-geo": [
    { group: "Chapter activities", label: "Try this / Make friends with maps! / Can you tell?", kind: "exercise", refPrefixes: ["Act "] },
    { group: "Exercise", label: "Exercise", kind: "exercise", refPrefixes: ["Ex "] },
  ],
  "population-1-12-geo": [
    { group: "Chapter activities", label: "Try this / Give it a try / Can you tell?", kind: "exercise", refPrefixes: ["Act "] },
