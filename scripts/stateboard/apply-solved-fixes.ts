 ...
 *
 *   npx tsx scripts/stateboard/apply-solved-fixes.ts <chapterId>          # dry-run
 *   npx tsx scripts/stateboard/apply-solved-fixes.ts <chapterId> --apply  # write
 *
 ...
 * teaches the error. The shipped precedent here is Ch.5 Oscillations
 * `5.1(iii)`, whose printed working substitutes the wrong displacement; the rule
 * earned there, and in mh-sb-11's Ch.4 `4.6 SolvedEx.8`, is: correct
