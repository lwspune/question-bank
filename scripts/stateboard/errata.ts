 ...
 *
 *   npx tsx scripts/stateboard/errata.ts            # print the report to stdout
 *   npx tsx scripts/stateboard/errata.ts --write    # also write generated-papers/StateBoard_Errata.md
 *
